...
class TestCbSetupPhase1:
    ...
    def vault(self, tmp_path):
        v = tmp_path / "vault"
        v.mkdir()
        write_note(v, "AI/Claude-Sessions/Decision A.md", """\
---
type: decision
...
## Decision
""")
        write_note(v, "AI/Claude-Sessions/Problem B.md", """\
---
type: problem
...
""")
    ...
    def test_includes_existing_claude_md_in_analysis(self, vault):
        ...
        (vault / "CLAUDE.md").write_text("# Vault Instructions\n\nUse type: decision.\n")
...
class TestCbEnrichCandidateDetection:
    ...
    def test_flags_note_missing_type(self, vault):
        ...
        write_note(vault, "Typed Note.md", """\
---
...
""")
    ...
    def test_flags_note_missing_summary(self, vault):
        ...
        write_note(vault, "No Summary.md", """\
---
type: decision
tags: [python, api]
---
...
""")
    ...
    def test_skips_fully_enriched_note(self, vault):
        ...
        write_note(vault, "Fully Enriched.md", """\
---
type: decision
...
""")
    ...
    def test_skips_template_notes(self, vault):
        ...
        write_note(vault, "templates/Decision Template.md", """\
# Decision Template
...
class TestCbEnrichNormalMode:
    ...
    def test_enriches_note_with_no_frontmatter(self, vault):
        ...
        """
        note_path = write_note(vault, "Manual Note.md", textwrap.dedent("""\
    ...
    def test_enriches_note_with_partial_frontmatter(self, vault):
        ...
        """
        note_path = write_note(vault, "Partial.md", textwrap.dedent("""\
            ---
            type: insight
    ...
    def test_overwrite_mode_replaces_existing_fields(self, vault):
        ...
        note_path = write_note(vault, "Overwrite Me.md", textwrap.dedent("""\
            ---
            type: decision
            summary: Old summary.
            tags: [old-tag]
